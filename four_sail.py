...
def calc_lidf(a, b):
    lidf = [0 for i in range(13)]

    angles1 = [i * 10 for i in range(1, 9)]
    angles2 = [j for j in range(82, 90, 2)]
...
def calc_lidf_verhoef(a, b, n_elements=18):
    ...
    #angle_reverse = ([5., 15., 25., 35., 45., 55., 65., 75., 81., 83., 85., 87., 89.])
    #angles = list(reversed(angle_reverse))
    for angle in angles:
        tl1 = np.radians(angle)
        if a > 1.0:
            f = 1.0 - np.cos(tl1)
